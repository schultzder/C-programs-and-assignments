...
public:
   ...
   void Delete()
   {
      ...
      else
      {
         ...
         playerNames[index] = playerNames[numPlayers - 1];
         teams[index] = teams[numPlayers - 1];
         averages[index] = averages[numPlayers - 1];
         numPlayers--; 
   ...
   { 
      for (int i = 0; i < numPlayers - 1; i++)
      {
         ...
         string tempPlayerNames = playerNames[i];
         string tempTeams = teams[i];
         float tempAvg = averages[i];

         playerNames[i] = playerNames[mindex];
         teams[i] = teams[mindex];
         averages[i] = averages[mindex];

         playerNames[mindex] = tempPlayerNames;
         teams[mindex] = tempTeams;
         averages[mindex] = tempAvg;
